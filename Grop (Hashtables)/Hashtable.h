...
private:
    ...
    /**
     * @brief Computes the hash value of the key
     *
     * @param key         The key
     * @return size_t The corresponding value of provided key
     */
     ...
     * @return size_t The corresponding value of provided key
     */
     void swap(Hashtable<Value> &other); 
    ...
    std::vector<std::vector<KeyValue>> hashtable;
};
